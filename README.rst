...
:note: Bioconvert is tested with Travis for the following Python version: 2.7.9
       3.4.2 and 3.5.0
...
Bioconvert is a set of tools gathered from several other Python packages. The goal
