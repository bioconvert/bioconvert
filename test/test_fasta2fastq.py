...
def test_conv(method):
    infile = f"{test_dir}/data/fasta2fastq/test_fastq2fasta_v1.fasta"
    qual_file = f"{test_dir}/data/fasta2fastq/test_fasta2fastq.qual"

    expected_outfile_no_qual = f"{test_dir}/data/fasta2fastq/test_fasta2fastq.fastq"
    md5out_no_qual = md5(expected_outfile_no_qual)

    expected_outfile_qual = f"{test_dir}/data/fasta2fastq/test_fastq2fasta_v1.fastq"
